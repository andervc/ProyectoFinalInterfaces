...
function calificacion(id) {
    ...
    if (document.getElementById('radio1-' + id).checked) {
        puntuacion = 5
    } else if (document.getElementById('radio2-' + id).checked) {
        puntuacion = 4
    } else if (document.getElementById('radio3-' + id).checked) {
        puntuacion = 3
    } else if (document.getElementById('radio4-' + id).checked) {
        puntuacion = 2
    } else if (document.getElementById('radio5-' + id).checked) {
        puntuacion = 1
    } else {
        puntuacion = 0
    }
